				    		...
				    		for(int i=itemCount; i >= 0; i--){
				    			if(checkedItemPositions.get(i)){	    				
				    				...
				    				if(r!=null){
				    					...
				    					String[] imagePath = r.IMAGE.split(":");
				    					for(String deleteImg: imagePath){
				    						if (deleteImg != "") {
				    							String contextFilesPath = getBaseContext().getFilesDir().getPath();
				    							deleteImg = deleteImg.replace(contextFilesPath + "/", "");
				    							getBaseContext().deleteFile(deleteImg);
				    						}
				    					}
